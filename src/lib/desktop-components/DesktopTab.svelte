        ...
        <div bind:this={biggie} class="relative flex flex-row content-center rounded-full ">
            ...
            <!--class:bg-black={page.url.pathname===tab.path} -->
                {#if page.url.pathname===tab.path}
                    <button bind:this={active} id={tab.id} class="z-10 px-3 py-1.5 text-white dark:text-black rounded-full transition duration-300 hover:scale-110 active:scale-90">
